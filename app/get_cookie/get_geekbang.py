...
用法:
  python tools/get_cookie/get_geekbang.py
  python tools/get_cookie/get_geekbang.py --browser chrome
  python tools/get_cookie/get_geekbang.py --profile "Profile 1"
