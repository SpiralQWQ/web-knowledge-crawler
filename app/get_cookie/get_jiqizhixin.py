...
用法:
  python app/get_cookie/get_jiqizhixin.py
  python app/get_cookie/get_jiqizhixin.py --browser chrome
  python app/get_cookie/get_jiqizhixin.py --profile "Profile 1"
