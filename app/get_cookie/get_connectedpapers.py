...
用法:
  python tools/get_cookie/get_connectedpapers.py
  python tools/get_cookie/get_connectedpapers.py --browser chrome
  python tools/get_cookie/get_connectedpapers.py --profile "Profile 1"
