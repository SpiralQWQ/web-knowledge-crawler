...
用法:
  python tools/get_cookie/get_googledocs.py
  python tools/get_cookie/get_googledocs.py --browser chrome
  python tools/get_cookie/get_googledocs.py --profile "Profile 1"
