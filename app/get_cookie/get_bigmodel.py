...
用法:
  python tools/get_cookie/get_bigmodel.py
  python tools/get_cookie/get_bigmodel.py --browser chrome
  python tools/get_cookie/get_bigmodel.py --profile "Profile 1"
