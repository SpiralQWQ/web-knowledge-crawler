...
用法:
  python app/get_cookie/get_stackoverflow.py
  python app/get_cookie/get_stackoverflow.py --browser chrome
  python app/get_cookie/get_stackoverflow.py --profile "Profile 1"
