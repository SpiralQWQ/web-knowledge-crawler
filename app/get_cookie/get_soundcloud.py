...
用法:
  python app/get_cookie/get_soundcloud.py
  python app/get_cookie/get_soundcloud.py --browser chrome
  python app/get_cookie/get_soundcloud.py --profile "Profile 1"
