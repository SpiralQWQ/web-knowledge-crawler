...
用法:
  python app/get_cookie/get_modelscope.py
  python app/get_cookie/get_modelscope.py --browser chrome
  python app/get_cookie/get_modelscope.py --profile "Profile 1"
