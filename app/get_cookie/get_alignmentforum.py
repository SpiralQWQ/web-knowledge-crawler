...
用法:
  python app/get_cookie/get_alignmentforum.py
  python app/get_cookie/get_alignmentforum.py --browser chrome
  python app/get_cookie/get_alignmentforum.py --profile "Profile 1"
