...
用法:
  python tools/get_cookie/get_lobsters.py
  python tools/get_cookie/get_lobsters.py --browser chrome
  python tools/get_cookie/get_lobsters.py --profile "Profile 1"
