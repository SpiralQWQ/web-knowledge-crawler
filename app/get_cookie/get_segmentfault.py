...
用法:
  python app/get_cookie/get_segmentfault.py
  python app/get_cookie/get_segmentfault.py --browser chrome
  python app/get_cookie/get_segmentfault.py --profile "Profile 1"
