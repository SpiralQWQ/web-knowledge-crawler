...
用法:
  python app/get_cookie/get_nounproject.py
  python app/get_cookie/get_nounproject.py --browser chrome
  python app/get_cookie/get_nounproject.py --profile "Profile 1"
