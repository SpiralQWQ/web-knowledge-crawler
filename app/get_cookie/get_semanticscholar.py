...
用法:
  python app/get_cookie/get_semanticscholar.py
  python app/get_cookie/get_semanticscholar.py --browser chrome
  python app/get_cookie/get_semanticscholar.py --profile "Profile 1"
