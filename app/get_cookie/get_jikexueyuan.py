...
用法:
  python app/get_cookie/get_jikexueyuan.py
  python app/get_cookie/get_jikexueyuan.py --browser chrome
  python app/get_cookie/get_jikexueyuan.py --profile "Profile 1"
